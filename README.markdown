...
This directory contains source files for the Ter Sami language
...
-   <http://giellatekno.uit.no/sjt/index.html>
-   <https://giellalt.uit.no/tools/docu-sjt-manual.html>
...
The Ter Sami language sources can be acquired using [giella SVN
